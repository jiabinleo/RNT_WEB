$(function () {
    ...
    var menu = [{
        name: '降水',
        code: 'gh',
        old: ['0', '1.0', '0.6', '1.2', '1.0', '0.4', '0.2', '0.2', '0', '1.0', '0.6', '1.2', '1.0', '0.4', '0.2', '0.2'],
        date: ['12日', '13日', '14日', '15日', '16日', '17日', '18日', '19日', '12日', '13日', '14日', '15日', '16日', '17日', '18日', '19日'],
        new: ['1.0', '1.1', '0.2', '1.4', '1.6', '0.2', '0.4', '09', '1.0', '1.1', '0.2', '1.4', '1.6', '0.2', '0.4', '09'],
    }, {
        name: '积温',
        code: 'dw',
    ...
    var zhjc = {
        ...
        listen() {
            ...
            menu.forEach((ele, index) => {
                var trHTML = ""
                ele.date.forEach((el, index) => {
                    trHTML +=
                        `<tr>
                        <td>${ele.date[index]}</td>
                        <td>${ele.new[index]}</td>
                        <td>${ele.old[index]}</td>
                    </tr>`
                })
