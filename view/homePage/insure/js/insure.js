$(function () {
    ...
    var insure = {
        init: function () {
            $.ajax({
                url: localhost50010 + "/policy/optionList" + idOrPolicyId,
                type: "GET",
                dataType: "json",
                async: false,
                headers: {
                    ...
                    if (data.code === "0") {
                        ...
                        for (let j = 0; j < optionListData.length; j++) {
                            ...
                            if (optionListData[j].optionCode === "holder_zjlx" || optionListData[j].optionCode === "beneficiary_zjlx") {
                                console.log(optionListData[j].dataValue)
        ...
        listen: function () {
            ...
            $(document).on("touchend", ".idType", function () {
                $.ajax({
                    url: localhost50010 + "/policy/zhengjian",
                    type: "GET",
                    dataType: "json",
                    headers: {
                        'Content-Type': 'application/json'
            ...
            $(document).on("click", "#benTrue", function () {
