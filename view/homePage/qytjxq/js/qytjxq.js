var enterprise = {
    ...
    listen: function () {
        enterData = {
            ...
            banner: ["../../../img/banner2.png", "../../../img/banner1.png", "../../../img/banner2.png", "../../../img/banner1.png", "../../../img/banner2.png"],
            comment: [{
                logoImgUrl: "../../../img/45logo.png",
                userName: "悦农通",
                type: "农业金融专家",
                address: "深圳市南山区",
                ...
                `<li>
                    ...
                    <div class="count">
                        <p>
                            ...
                            <img src="../../../img/zan_hide.png" alt=""><span>${enterData.comment[i].heart}</span>
